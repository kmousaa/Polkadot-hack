...
const tags = ['MUSIC', 'PROJECT', 'CHARITY', 'EDUCATION', 'TECHNOLOGY', 'ART', 'SPORTS', 'FUNDRAISER'];
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="w-1/5 h-screen sticky top-0 p-4 bg-light-background shadow-lg space-y-6 py-5">
                ...
                <div className="flex flex-col space-y-3"> {/* Arrange buttons in a column with space between */}
                {tags.map((tag, index) => (
                    <Button 
                        key={index} 
                        color="primary" 
            ...
            <div className="flex-1 ml-4 space-y-4 overflow-y-auto p-4 items-center px-32 py-5 ">
                ...
                {users.map((user, index) => (
                    <div className="mb-10" key={index}> {/* Margin-bottom added here */}
                        <Card 
                            title={user.title}
